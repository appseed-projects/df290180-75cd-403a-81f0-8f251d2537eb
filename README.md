...
- Timestamp: `2022-06-15 10:41`
- Build ID: `df290180-75cd-403a-81f0-8f251d2537eb`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/df290180-75cd-403a-81f0-8f251d2537eb.git
$ cd df290180-75cd-403a-81f0-8f251d2537eb
```
